...
// Variable para s.
  ...
  // El ID ahora lo asigna el backend; no se genera localmente.
...
// Variable para mesa parsed.
    ...
    // TODO(JWT): agregar() hace POST /invitados/ (endpoint protegido).
    //            Asegúrate de que ApiClient tenga el token antes de llamar.
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('No se pudo guardar. Verifica tu conexión.'),
          backgroundColor: Theme.of(context).colorScheme.error,
          behavior: SnackBarBehavior.floating,
        ),
      );
